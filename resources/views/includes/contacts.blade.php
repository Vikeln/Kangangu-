<div class="container" id="contacts"><br><br>
  <div class="header-section text-center">
    <h2>KANGANGU HIGH SCHOOL CONTACT FORM</h2>
  </div>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <p><i class="fa fa-phone" style="font-size:24px"></i> Phone: 998300161</p>
      <p><i class="fa fa-envelope" style="font-size:24px"></i> Email: example@example.com</p>
      <p><i class="fa fa-mobile-phone" style="font-size:36px"></i> Mobile: 0750300161</p>
    </div>
    <div class="col-sm">
